...
test.describe('Theme Toggle Functionality', () => {
  ...
  test('should update theme toggle icon/text when theme changes', async ({ page }) => {
    ...
    const buttonChanged = initialAriaLabel !== newAriaLabel || initialInnerHTML !== newInnerHTML;
  ...
  test('should respect system theme preference on first visit', async ({ page, context }) => {
    ...
    const hasDarkTheme =
      bodyClass.includes('dark') || htmlClass.includes('dark') || dataTheme.includes('dark');
